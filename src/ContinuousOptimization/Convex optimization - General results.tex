...
\begin{theorem}[Three-slopes inequality]\label{thm:slopes-inequality}
    For all $ a < b < c $ in $ I $,
...
\begin{remark}
    This is extremely powerful. It can be generalized to aligned points on a same line in $ n $-dimensions.
\end{remark}
